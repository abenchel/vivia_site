        ...
        <div className="grid gap-6 md:grid-cols-3 relative">
          ...
          {processSteps.map((step, index) => (
            ...
            >
              ...
              <p className="text-sm text-primary mb-3 font-semibold mt-2">Étape {index + 1}</p>
              <p className="text-foreground font-bold text-lg mb-2 group-hover:text-primary transition-colors duration-300">{step.title}</p>

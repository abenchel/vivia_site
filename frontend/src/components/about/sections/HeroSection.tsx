      ...
      <div className="relative z-10 w-full grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center">
        <div className="flex flex-col gap-8">
          ...
          <h1 className="text-5xl md:text-7xl font-black leading-[1.1]">
            <span className="block text-foreground mb-2">Une équipe engagée pour</span>
            <span className="block bg-clip-text text-transparent bg-gradient-to-r from-violet-400 via-cyan-400 to-purple-400">
              rendre l'IA utile et accessible
            </span>
          </h1>

          <p className="max-w-xl text-xl text-muted-foreground/90 leading-relaxed">
            VIVIA accompagne les PME dans leur transformation digitale grâce à des solutions d'automatisation, data et IA pensées pour la réalité du terrain.
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            >
              <a href="/contact" className="flex items-center gap-3">
                <span className="relative z-10">Discuter avec un expert</span>
          ...
          <div className="relative grid gap-5">
              ...
              <div className="group relative overflow-hidden rounded-3xl aspect-[4/3]">
                ...
                <div className="absolute bottom-4 left-4 right-4 flex flex-wrap gap-3">
                  <div className="rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md px-4 py-3">
                    <p className="text-xs uppercase tracking-[0.3em] text-white/70">Vision</p>
                    <p className="text-sm text-white font-semibold">Stratégie & alignement</p>
                  </div>
                  <div className="rounded-2xl border border-white/20 bg-white/10 backdrop-blur-md px-4 py-3">
                    <p className="text-xs uppercase tracking-[0.3em] text-white/70">Impact</p>
                    <p className="text-sm text-white font-semibold">Co-construction terrain</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl border border-white/15 bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl p-4">
                <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground">Méthode</p>
                <p className="text-lg font-semibold text-foreground mt-2">Co-construction terrain</p>
                <p className="text-sm text-muted-foreground mt-2">
                  Ateliers courts, prototypage rapide et déploiement progressif.
                </p>
              </div>
              <div className="rounded-2xl border border-white/15 bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl p-4">
                <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground">Focus</p>
                <p className="text-lg font-semibold text-foreground mt-2">Impact mesurable</p>
                <p className="text-sm text-muted-foreground mt-2">
                  Gains suivis, adoption validée, ROI piloté.
                </p>
              </div>
            </div>
          </div>
